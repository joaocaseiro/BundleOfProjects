...
public class TaskDescriptor extends BaseDescriptor{
	...
	public static final String CONTENT_TYPE = "vnd.android.cursor.item/vnd."+TABLE_NAME;
	public static final Uri CONTENT_URI = XProviderDescriptor.BASE_URI.buildUpon().appendPath(TABLE_NAME).build();

	public static final String[] FIELDS = new String[] { ID, NAME, VALUE };

	public static final String PATH_MANY = TABLE_NAME;
	public static final String PATH_SINGLE = TABLE_NAME+"/*";
	public static final int TASK_MULTIPLE_TOKEN = 100;
	public static final int TASK_SINGLE_TOKEN = 200;
	...
	public static void onCreate(SQLiteDatabase db) {
		db.execSQL("create table "+TABLE_NAME+" ("+ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+NAME+" TEXT, "+VALUE+" INTEGER);");
	}
